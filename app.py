...
st.markdown(
    ...
    /* Prevent the calendar's Streamlit column system from
       collapsing into a vertical stack on narrow screens. */
    /*
       IMPORTANT:
       Streamlit's responsive column layout can stack columns on
       narrow screens. The calendar must remain a true 7-column grid.
       Support both current and older Streamlit test IDs.
    */
    ...
    .calendar-grid [data-testid="stColumn"] > div,
    .calendar-grid [data-testid="column"] > div {
        width: 100% !important;
        min-width: 0 !important;
    }
